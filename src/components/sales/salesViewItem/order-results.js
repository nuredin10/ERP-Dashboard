...
import salesAxios from '../../salesAxios'
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  <Box sx={{ marginLeft: "20%" }}>
                    <Typography variant="h6">{e.salesStore_name}</Typography>
                    <Typography variant="body1">{e.salesStore_spec}</Typography>
                  </Box>
                </Box>
                {}
                <Box
                ...
                >
                  <Typography sx={{ textAlign: "center" }}>{e.salesStore_materialcode}</Typography>
                </Box>
              </Grid>
            ))}
          </Grid>
