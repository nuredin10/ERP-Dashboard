...
const Addpurchasedmaterial = () => {
  ...
  const [inputFields, setInputFields] = useState([
    { new_name: '', new_quantity: '', new_materialunit: '', new_materialcode: '', new_spec: '', new_description: '', new_value: '', new_referncenum: '', new_materialtype: '', new_remark: '', new_status: 'NEW' }
  ])
  ...
  const addFields = () => {
    let newfield = { new_name: '', new_quantity: '', new_materialunit: '', new_materialcode: '', new_spec: '', new_description: '', new_value: '', new_referncenum: '', new_materialtype: '', new_remark: '', new_status: 'NEW' }
    setIsSuccess('info');
            ...
            <Grid container spacing={4} >
              {
                inputFields.map((input, index) => {
                  return (
                    <Grid container spacing={2} sx={{ boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px", ml :3, mt:3, backgroundColor: 'white', pb: 2, borderRadius: '10px'}}>
              ...
              <Grid item lg={8}>
                <Button type="submit" sx={{ marginRight: "2rem" }} onClick={submitHandler} variant="contained">
                  Save
                </Button>
                <Button variant="outlined" onClick={clearAllHandler}>Clear All</Button>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
