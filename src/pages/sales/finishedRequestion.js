...
const ProductionOrderGM = () => {
  ...
  const newRequest = (data) => {
    console.log(data);
    var newData = { ...data, order_date: datepick.toString() };
    axios
      .post("/finishedgoodRequestion", newData)
      .then((res) => {
        console.log(res);
        ...
        axios
          .post("/sendNotification", {
            To: "warehouse",
            message: "New Production Requestion",
          })
          .then((respo) => {
  ...
  return (
    <>
      <Head>
        <title>Add Finished Good Requestion</title>
      </Head>
      <Box
        component="main"
        sx={{
              ...
              <form onSubmit={handleSubmit(newRequest)}>
                <Grid container spacing={4}>
                  <Grid item xs={12} sm={12}>
                    <Typography variant="h5">Add Finished Good Requestion</Typography>
                  </Grid>
