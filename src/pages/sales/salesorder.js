                                                    ...
                                                    >
                                                        <Grid item sm={6} md={2} lg={3}>
                                                            <FormControl fullWidth>
                                                                <InputLabel id="demo-simple-select-label">Finished
                                                                    Goods</InputLabel>
                                                                <Select
                                                                    required
                                                                    name="fin_product"
                                                        ...
                                                        <Grid item sm={6} md={2} lg={3}>
                                                            <FormControl fullWidth>
                                                                <InputLabel id="demo-simple-select-label">Product
                                                                    Color</InputLabel>
                                                                <Select
                                                                    required
                                                                    name="final_color"
                                                        ...
                                                        <Grid item sm={6} md={2} lg={3}>
                                                            <FormControl fullWidth>
                                                                <InputLabel id="demo-simple-select-label">Materials
                                                                    Code</InputLabel>
                                                                <Select
                                                                    required
                                                        ...
                                                        <Grid item sm={6} md={2} lg={3}>
                                                            <FormControl fullWidth>
                                                                <InputLabel id="demo-simple-select-label">Material Diameter(OD)</InputLabel>
                                                                <Select
                                                                    required
                                                                    name="final_diameter"
