...
const ProductionOrderGM = () => {
  ...
  const newRequest = (data) => {
    const dataAll = {
      ...
      Item_description: "Electric Bill Payment",
      uom: " ",
      unit_price: "",
      total_price: data.Elec_Payment,
  ...
  return (
    <>
      <Head>
        <title> Add Electric Bill Expense</title>
      </Head>
      <Box
        component="main"
        sx={{
              ...
              <form onSubmit={handleSubmit(newRequest)}>
                <Grid container spacing={4}>
                  <Grid item xs={12} sm={12}>
                    <Typography variant="h5">Add Electric Bill Expense</Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      required
                      name="Electric Bill Reference Number"
                      label="Electric Bill Reference Number"
                      type="text"
                      fullWidth
                      {...register("Fs_number")}
                    />
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      required
                      name="Electric Bill Price"
                      label="Electric Bill Price"
                      type="text"
                      fullWidth
                      {...register("Elec_Payment")}
                    />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField
