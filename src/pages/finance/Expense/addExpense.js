...
const ProductionOrderGM = () => {
  ...
  const newRequest = (data) => {
    ...
    const dataAll = {
      ...
      Item_description: data.Employee_Name,
      uom: " ",
      unit_price: "",
      total_price: data.Employe_salary,
    ...
    axios
      ...
      .then((res) => {
        enqueueSnackbar("Saved Successfully", { variant: "success" });        console.log(res);

      })
      .catch((err) => {
        enqueueSnackbar("Error Occured", { variant: "error" });        console.log(res);
