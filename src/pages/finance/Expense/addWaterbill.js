...
const ProductionOrderGM = () => {
  ...
  const newRequest = (data) => {
    const dataAll = {
      ...
      Item_description: "Water Bill Payment",
      uom: " ",
      unit_price: "",
      total_price: data.wat_Payment,
              ...
              <form onSubmit={handleSubmit(newRequest)}>
                <Grid container spacing={4}>
                  <Grid item xs={12} sm={12}>
                    <Typography variant="h5">Add Water Bill Expense</Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      required
                      name="Water Bill Reference Number"
                      label="Water Bill Reference Number"
                      type="text"
                      fullWidth
                      {...register("Fs_number")}
                    />
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      required
                      name="Water Bill Price"
                      label="Water Bill Price"
                      type="text"
                      fullWidth
                      {...register("wat_Payment")}
                    />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField
